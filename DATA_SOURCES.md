...
This document catalogs the exact source of every field in the `stdItem` output format, tracing from the Game2.xml (DataForge) XML structure through the parser layers to the final builder output.
