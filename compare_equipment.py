...
Slices:
    vehicle_equipment ↔ temp/reference/entry_3.json (ship gear)
    fps_equipment     ↔ temp/reference/entry_4.json (FPS weapons + attachments)
"""
import json
import sys
...
def main():
    ...
    e3 = {r["className"]: r for r in _load("temp/reference/entry_3.json", bom=True)}
    e4 = {r["className"]: r for r in _load("temp/reference/entry_4.json", bom=True)}
