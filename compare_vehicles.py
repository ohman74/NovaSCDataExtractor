...
Slices:
    vehicle_metadata   ↔ temp/reference/entry_0.json
    vehicle_stats      ↔ temp/reference/entry_1.json
    vehicle_hardpoints ↔ temp/reference/entry_2.json
...
def main():
    ...
    e0 = _load_json("temp/reference/entry_0.json")
    e1 = _strip_nested(_load_json("temp/reference/entry_1.json"), _SKIP_NESTED_STATS)
    e2 = _load_json("temp/reference/entry_2.json")
